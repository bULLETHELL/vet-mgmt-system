...
namespace vet_mgmt_system
{
    ...
    public partial class VetMgmtSystemDbEntities : DbContext
    {
        ...
        public virtual ObjectResult<proc_GetInvoiceByOwnerName_Result1> proc_GetInvoiceByOwnerName(string ownerName)
        {
            var ownerNameParameter = ownerName != null ?
                new ObjectParameter("OwnerName", ownerName) :
                new ObjectParameter("OwnerName", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<proc_GetInvoiceByOwnerName_Result1>("proc_GetInvoiceByOwnerName", ownerNameParameter);
        }
